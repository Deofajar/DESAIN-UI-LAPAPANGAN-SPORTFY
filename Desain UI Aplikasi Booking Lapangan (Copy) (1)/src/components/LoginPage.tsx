  ...
  return (
    <div className="min-h-screen bg-[#121212] flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full bg-[#1DB954] hover:bg-[#1ed760] text-white py-6"
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1761644273884-83839f8f22e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRvb3IlMjBzcG9ydHMlMjBjb3VydHxlbnwxfHx8fDE3NjIwODE4NjZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Sports Court"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 z-20 bg-gradient-to-t from-[#121212] to-transparent">
          <h3 className="text-white mb-4" style={{ fontSize: '1.5rem' }}>
            Lapangan Olahraga Terbaik
          </h3>
          <div className="flex gap-6 text-gray-300">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#1DB954]"></div>
              <span>6 Lapangan Futsal</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#1DB954]"></div>
              <span>5 Lapangan Voli</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#1DB954]"></div>
              <span>4 Lapangan Basket</span>
            </div>
          </div>
        </div>
      </div>
